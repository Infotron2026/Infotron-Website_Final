        ...
        <div className="space-y-10 text-gray-300">
          <section>
            ...
            <p className="leading-relaxed">
              By accessing and using the Infotron Solutions website and services, you accept and agree to be 
              bound by these Terms of Service. If you do not agree to these terms, please do not use our 
              website or services. These terms apply to all visitors, users, clients, and others who access 
              or use our services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              Infotron Solutions provides IT consulting, managed services, staff augmentation, and business 
              consulting services to enterprise and growth-stage organizations. Our website provides information 
              about our services, career opportunities, and resources for potential clients and candidates.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              software, is the property of Infotron Solutions or its content suppliers and is protected by 
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">5. Client Engagements</h2>
            <p className="leading-relaxed">
              All client engagements, including managed services, staff augmentation, and consulting projects, 
              are governed by separate service agreements (Master Service Agreements, Statements of Work, etc.) 
              negotiated and executed between Infotron Solutions and the client. These Terms of Service do not 
              constitute a service agreement and do not create any obligation for Infotron Solutions to provide 
              services.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-white mb-4">6. Job Applications</h2>
            <p className="leading-relaxed">
              Job applications submitted through our careers portal are processed by CEIPAL, our applicant 
              tracking system provider. By submitting a job application, you agree to CEIPAL's terms of service 
              and privacy policy. Submission of an application does not guarantee employment or create any 
              employment relationship with Infotron Solutions.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              EITHER EXPRESS OR IMPLIED. INFOTRON SOLUTIONS DISCLAIMS ALL WARRANTIES, INCLUDING BUT NOT LIMITED TO 
              IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. WE DO 
              NOT WARRANT THAT THE WEBSITE WILL BE UNINTERRUPTED, SECURE, OR ERROR-FREE.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              TO THE FULLEST EXTENT PERMITTED BY LAW, INFOTRON SOLUTIONS SHALL NOT BE LIABLE FOR ANY INDIRECT, 
              INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER 
              INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, 
              RESULTING FROM YOUR ACCESS TO OR USE OF THE WEBSITE OR SERVICES.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              You agree to indemnify, defend, and hold harmless Infotron Solutions, its affiliates, officers, 
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              by Infotron Solutions. We have no control over and assume no responsibility for the content, privacy 
              policies, or practices of any third-party websites or services. You acknowledge and agree that 
              Infotron Solutions shall not be responsible or liable for any damage or loss caused by or in 
          ...
          <section>
            ...
            <p className="leading-relaxed">
              Any confidential information shared with Infotron Solutions through the website, including business 
              requirements, technical specifications, or other proprietary information, will be treated as 
              confidential and will not be disclosed to third parties without your consent, except as required 
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              Terms shall be subject to the exclusive jurisdiction of the courts located in Clark County, Nevada.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              "Last updated" date. Your continued use of the website after any such changes constitutes your 
